...
{
public:
	SessionEcho(boost::asio::io_context* io_service);
...
{
public:
	SessionSend(boost::asio::io_context* io_service);
	tcp::socket& get_socket();
...
{
public:
	Server(boost::asio::io_context* io_service, short port1, short port2 );
